...
package toolbox.modeltools.algorithms;
 ...
 */
public class MLP_Visualization  extends AbstractClassifier  implements OptionHandler, WeightedInstancesHandler, Randomizable
{
...
private boolean flag=false;
   ...
   */
  public void runMLP(String [] argv, String outputFile) 
  {
    this.outputFile=outputFile;    
    runClassifier(this, argv);
  ...
  protected class NeuralEnd
     ...
     * runMLP. This will also call the reset function of all units that are
  ...
  public boolean getReset() {
    ...
    public NodePanel getM_nodePanel() {
        return m_nodePanel;
    }

    public void setM_nodePanel(NodePanel m_nodePanel) {
        this.m_nodePanel = m_nodePanel;
    }
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_gui)     
    {
      ...
      m_nodePanel.setPreferredSize(new Dimension(800, 850));
      //m_nodePanel.revalidate();
      
      
     
      m_nodePanel.setVisible(true);
