 ...
 */
public class MLP  extends AbstractClassifier  implements OptionHandler, WeightedInstancesHandler, Randomizable
{
  ...
  public void buildClassifier(Instances instances) throws Exception {
    ...
    if (m_gui)     
    {
      ...
      if (this.outputFile!=null)
         VisualizationTools.VisualizationToFile(m_nodePanel, this.outputFile);      
      */
    }
